<template>
    <div class="page--faq">
        ...
        <div class="cardGroup cardGroup--large">
        ...
        <div class="cardGroup">
            <div class="card">
                ...
                <p>
                    ...
                    Vous changer d'avis autant de fois que vous voulez avant.
...
<style scoped>
    ...
    @media (min-width: 850px) and (max-width: 1200px) {
        .cardGroup.cardGroup--large .card:not(:first-child) {
            margin-left: 0;
        }
    }
